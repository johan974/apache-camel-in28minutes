...
public class MyFirstTimerRouter extends RouteBuilder {
  ...
  @Autowired
  private DuplicateMessage duplicateMessage;
  ...
  public void configure() throws Exception {
    ...
    from("timer:first-timer") //null
            ...
            .bean(loggingComponent) // heeft een void method - leave body as it is
            .log("${body}")
            .bean(duplicateMessage)
            .log("${body}")
...
class DuplicateMessage {
  public String process(String message) {
    return "Duplicated: " + message + "+" + message;
  }
}
